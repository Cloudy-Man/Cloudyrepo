...
public class Model extends Observable {
    ...
    public boolean tilt(Side side) {
        ...
        for (int c=0;c<this.board.size();c++){
            int R=this.board.size()-1;
            Tile tile1=this.board.tile(c,R);
            ...
            for (int r=this.board.size()-2;r>=0;r--){
                ...
                if (tile1==null || this.board.tile(c,R).value()==tile2.value()) {
                    if (this.board.move(c,R,tile2)) {
                        this.score+=this.board.tile(c,R).value();
                        R--;
                        tile1=this.board.tile(c,R);
                    }
                    tile1=this.board.tile(c,R);
                    changed=true;
                } else {
